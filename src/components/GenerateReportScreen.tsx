...
export default function GenerateReportScreen() {
  ...
  return (
    <main className="generate-report-screen" id="report">
      ...
      <section className={`report-readiness report-readiness-${intelligence.reportReadiness.status}`} aria-labelledby="report-readiness-heading">
        <div className="report-readiness-heading"><div><p className="report-eyebrow">WeekFlow Intelligence</p><h2 id="report-readiness-heading">Report Readiness</h2><p>{intelligence.reportReadiness.summary}</p></div><strong>{intelligence.reportReadiness.status}</strong></div>
        <div className="report-readiness-counts"><span><strong>{intelligence.reportReadiness.activityCount}</strong> Activities</span><span><strong>{intelligence.reportReadiness.openFollowUpCount}</strong> Open follow-ups</span><span><strong>{intelligence.reportReadiness.warningCount}</strong> Items needing review</span><span><strong>{intelligence.reportReadiness.highPriorityCount}</strong> High priority</span></div>
      </section>
